<?php
$base_url = 'http://localhost/social-media-downloader/';
...
<head>
    <meta charset="utf-8">
    <title>Social Media Dwonloader</title>
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">Social Media Downloader</h1>
                </a>
            ...
            <div class="container">
                <div class="row g-2">
                    <div class="col-md-10">
                        <div class="row g-2">
                            <div class="col-md-8">
                                <input id="link" type="text" class="form-control border-0 py-3" placeholder="Paste link here">
                            </div>
                            <div class="col-md-4">
                                <select class="form-select border-0 py-3">
                                    <option selected>Auto Detect</option>
                                    <option value="line-video">Line - Video</option>
                    ...
                    <div class="col-md-2">
                        <button id="generate" class="btn btn-dark border-0 w-100 py-3">Search</button>
                    </div>
                </div>
            </div>
        </div>
